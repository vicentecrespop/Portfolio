        ...
        <main className="min-h-[60vh] w-full pt-[150px] bg-[#0F0F0F] text-white flex flex-col md:flex-row justify-center lg:min-w-[960px] lg:w-[65vw]">
            <div>
                <div className="flex flex-col lg:flex-row items-center mx-5">
                    <div className="clear-container p-5 sm:p-7 rounded-3xl mx-5 sm:mx-0 sm:mr-5">
                        <Image src={profile2} width={340} alt="Profile" className="rounded-[25px] w-full"/>
                    </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 grid-rows-2 sm:grid-rows-1 gap-5 m-5">
                    ...
                    <div className="clear-container flex flex-col rounded-2xl p-5">
                        ...
                        <div className="flex flex-col mt-5">
                            ...
                            <span className="text-lg">Curso de Graduação de Desenvolvimento Full Stack</span>
